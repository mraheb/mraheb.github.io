...
* [**Vi**sual Editor Cheatsheet](/files/VI-editor-cheatsheet.pdf): Visual editor is a built-in text editor in the UNIX operating system. I frequently use vi editor for my research to edit and write scripts of code. Attached is cheatsheet containing common commands used in vi editor courtsey of the [College of Arts and Science at the University of Albany](http://www.atmos.albany.edu/index.php?d=wx_data). For a more comprehensive guide, click [here](https://www.cs.colostate.edu/helpdocs/vi.html).
